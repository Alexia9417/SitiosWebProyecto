        ...
        <div class="columna-izquierda">
            <div class="cuadro-izquierda">
                ...
                <div class="redes-sociales">
                    <h4>¡Síguenos y comparte tu experiencia!</h4>
                    <p>Usa el hashtag <strong>#RestauranteLaCapuzzelle</strong> y gana premios.</p>

                    <a href="https://facebook.com/restauranteLaCapuzzelle" target="_blank" class="facebook">
                        <i class="fab fa-facebook"></i> Facebook
                    </a>
                    <a href="https://instagram.com/restaurantexLaCapuzzelle" target="_blank" class="instagram">
                        <i class="fab fa-instagram"></i> Instagram
                    </a>
                    <a href="https://twitter.com/restauranteLaCapuzzelle" target="_blank" class="twitter">
