function iniciarContador(tsFinAccion, solicitudId) {
      ...
      fetch("/Sitios/Chef/models/completar_solicitud.php", {
        ...
        .then((r) => {
          if (r.success) {
            ...
            cargarSolicitudes(); // refrescar vista
          } else {
    ...
    .then((data) => {
      ...
      seccion.innerHTML = `
        <div class="flex justify-between items-center">
          <h2 class="flex items-center gap-2 text-lg font-bold text-[#4E5D83]">
            <i data-lucide="hand-heart" class="w-5 h-5 text-[#967ED5]"></i> Acciones Rápidas
          </h2>
        </div>
        <div class="text-sm font-semibold text-[#4E5D83] flex items-center gap-2">
