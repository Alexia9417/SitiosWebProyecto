    ...
    <div class="page-wrapper flex w-full">
        ...
        <div class="flex-1 max-w-[calc(100%-250px)] mx-auto p-6 overflow-y-auto">
            ...
            <section class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div id="solicitudesEmpleado" class="hidden mt-6 col-span-2">
                    <h2 class="text-xl font-semibold mb-4">Solicitudes de Empleado</h2>
                    <div id="listaSolicitudes" class="space-y-3 overflow-auto">
